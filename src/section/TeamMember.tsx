...
export const OurTeam = () => {
  return (
    <section id="team" className="OurTeam team_area bg-gray py-24">
      <div className="container">
        <div className="row justify-center">
          <div className="w-full lg:w-1/2">
            <div className="text-center pb-6">
              <h3>Modest Team</h3>
              <h1 className="text-[#062A73]">But with a big passion</h1>
            </div>
          </div>
        </div>
    ...
    <div className="OurTeamCard">
      <div className="flex flex-col justify-center">
        <div className="bg-white rounded-3xl flex justify-center items-center py-8 mb-2">
          <img src={profileUrl} alt="" className="w-150 h-150 rounded-full" />
        </div>
        <div className="member_info text-center flex flex-col gap-2 mb-6">
          <h3>Aung Htet Paing</h3>
          <div className="text-primary7">Founder</div>
          <h5>
